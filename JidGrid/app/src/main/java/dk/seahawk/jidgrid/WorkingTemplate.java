...
public class WorkingTemplate extends AppCompatActivity {

    private static final String TAG = WorkingTemplate.class.getSimpleName();
   ...
   //     setContentView(R.layout.activity_main);
    ...
    private void startGettingLocation() {
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED &&
            ...
            locationProviderClient.requestLocationUpdates(locationRequest,locationCallback, WorkingTemplate.this.getMainLooper());
            ...
            if(ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)){
                Toast.makeText(WorkingTemplate.this, "Permission needed", Toast.LENGTH_LONG).show();
            } else {
                ActivityCompat.requestPermissions(WorkingTemplate.this,
